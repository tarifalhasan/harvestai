            ...
            <div className="block rounded-lg  px-[30px] py-[50px] text-left shadow-[0_4px_60px_0_rgba(0,0,0,0.1)] sm:px-10">
              <form className="flex flex-col gap-y-5">
                  ...
                  <div className="flex flex-wrap justify-between gap-x-10 gap-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        ...
                        <span className="font-extrabold hover:text-red-500">
                          Terms & Conditions
                        </span>
                        {""} and {""} {""}
                        <span className="font-extrabold hover:text-red-500">
                ...
                <button type="submit" className="button mt-7">
                  <Button className=" bg-black py-4 text-white after:bg-red-500 hover:text-white border-2 rounded-[50px] md:px-28  font-primary sm:w-full px-20">
                    {" "}
                    Create account
                  </Button>
                </button>
