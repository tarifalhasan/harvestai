...
export default function NewCarousel() {
  ...
  return (
    <section className="w-full flex-col items-center justify-center s overflow-hidden">
      <div
        className="w-full  mx-auto p-4"
        onMouseEnter={() => setIsPaused(true)}
        onMouseLeave={() => setIsPaused(false)}
      >
        <div className="relative max-w-5xl mx-auto flex w-full flex-col  p-4 pt-6 md:p-6">
          {}
          <div className="relative w-full h-[280px] md:h-[400px] flex items-center justify-center  pt-12">
            <motion.div
          ...
          <div className="flex items-center justify-center gap-6 mt-6">
            ...
            <button
              ...
              className="p-2 rounded-full  bg-gray-300  border border-white/10 text-gray-700text-white transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500"
            >
              ...
              {cardData.map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 focus:outline-none ${
                    activeIndex === index
                      ? "w-6 bg-pink-400"
                      : "w-2 bg-gray-300bg-neutral-600 hover:bg-gray-400 dark:hover:bg-neutral-500"
                  }`}
